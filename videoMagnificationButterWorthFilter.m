...
% Butterworth bandpass filter based on Laplacian pyramid
...
function amplify_spatial_lpyr_temporal_butter(vidFile, outDir ...
    ...
    for i=startIndex+1:endIndex
            ...
            %% temporal filtering using the high and low cutoff frequency
            ...
            % the factor to boost alpha above the bound given
            ...
            for l = nLevels:-1:1
              ...
              % calculate the modified alpha for this level
            ...
            %% Render the video and reconstruct the output video
